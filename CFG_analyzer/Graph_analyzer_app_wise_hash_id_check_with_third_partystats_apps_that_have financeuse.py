...
fw=open('Financial_lib_using_app_wise_thirdparty_stats.csv','w+')
...
ff = open('Apps_that_use_Financial_libs.txt','r')
#infile=sys.argv[1]
#ff = open(infile,'r')
...
fff = open('thirdPartyWords_without_financial_terms.txt','r')
...
for file in Apps:
    ...
    guid_o = 0
    appcount+=1
    IMEI_id_methods=find_methods(IMEI,"AppsWithFinancialLibraries/"+file)
    IMSI_id_methods=find_methods(IMSI,"AppsWithFinancialLibraries/"+file)
    android_id_methods=find_AndroidID_methods(AndroidID,"AppsWithFinancialLibraries/"+file)
    mac_id_methods = find_methods(MacAddress, "AppsWithFinancialLibraries/" + file)
    serial_id_methods = find_methods(SERIAL, "AppsWithFinancialLibraries/" + file)
    ad_id_methods = find_methods(AdvertisingID, "AppsWithFinancialLibraries/" + file)
    Guid_id_methods = find_methods(UUID, "AppsWithFinancialLibraries/" + file)
    ...
    fw.write('\n')
    print("written file: ", file, appcount)
