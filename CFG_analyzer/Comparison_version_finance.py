...
fw=open('comparison_with_updated_version_finance.csv','w+')
...
fw.write('\n')
c = 0
with open('Updated_finance_app_wise_thirdparty_stats.csv',encoding="utf8", errors='ignore') as f:
    ...
    for row in csvreader:
        ...
        found=0
        with open('finance_app_wise_thirdparty_stats.csv', encoding="utf8", errors='ignore') as ff:
