...
fw=open('prev_version_app_wise_id_stats.csv','w+')
...
ff = open('prev_ver_AppsName.txt','r')
#infile=sys.argv[1]
#ff = open(infile,'r')
...
for file in Apps:
    ...
    IMEI_id_methods=find_methods(IMEI,"Prev_version_top_apps/"+file)
    IMSI_id_methods=find_methods(IMSI,"Prev_version_top_apps/"+file)
    android_id_methods=find_AndroidID_methods(AndroidID,"Prev_version_top_apps/"+file)
    android_id_methods =android_id_methods + find_AndroidID_methods(AndroidID2, "Prev_version_top_apps/" + file)
    mac_id_methods = find_methods(MacAddress, "Prev_version_top_apps/" + file)
    serial_id_methods = find_methods(SERIAL, "Prev_version_top_apps/" + file)
    ad_id_methods = find_methods(AdvertisingID, "Prev_version_top_apps/" + file)
    Guid_id_methods = find_methods(UUID, "Prev_version_top_apps/" + file)
