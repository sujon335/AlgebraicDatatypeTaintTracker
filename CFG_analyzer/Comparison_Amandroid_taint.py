...
fw=open('Amandroid_taint_comparison_result.csv','w+')
...
fw.write('\n')
c = 0
with open('Amandroid_taint_result_top_apps.csv',encoding="utf8", errors='ignore') as f:
        ...
        with open('app_wise_hash_stats.csv', encoding="utf8", errors='ignore') as ff:
            ...
            for row2 in csvreader2:
                ...
                if (app!=fapp):
                    ...
                    if (str(row2[1]).strip()=="0") and (str(row2[2]).strip()=="0"):
                        imei=0
                    if(str(row2[3]).strip()=="0") and (str(row2[4]).strip()=="0"):
                        imsi=0
                    if(str(row2[5]).strip()=="0") and (str(row2[6]).strip()=="0"):
                        aid=0
                    if(str(row2[7]).strip()=="0") and (str(row2[8]).strip()=="0"):
                        sid=0
                    if(str(row2[9]).strip()=="0") and (str(row2[10]).strip()=="0"):
                        mac=0
